...
const fetchMessages = async (chat_group_id: string, pageParam: string | null = null) => {
  ...
  console.log("type of pageParams", typeof pageParam)
                      ...
                      <div key={message.id} className="relative">
                        <div className="relative flex flex-col">
                          ...
                          <div className="group/message flex">
                            ...
                            {/* message */}
                            <div
                              className={cn(`flex min-w-0 shrink grow`, {
                              ...
                              <div className="flex flex-col justify-start bg-transparent">
                                <div className="flex w-full flex-col">
                                  ...
                                  <div className="relative flex max-w-full flex-col items-start">
                                    <div
                                      className={cn(
                                        `bg-wash relative z-[1] -ml-2 overflow-hidden rounded-2xl px-2 py-2 text-white`,
                                        { "bg-blue-bg": message.isSentByCurrentUser },
                                      )}>
                              ...
                              <div
                                className={cn(
                                  `delay-70 invisible relative flex shrink-0 grow justify-center pl-[5px] opacity-0 transition-all group-hover/message:visible group-hover/message:opacity-100`,
                                  { "flex-row-reverse": message.isSentByCurrentUser },
                                )}
                                aria-hidden="true">
